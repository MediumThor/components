...
`yarn add @_arcanumdex/components`

or

`npm install @_arcanumdex/components`
...
react
react-dom
@_arcanumdex/sdk ( for version see below mapping )
```

#### components <-> sdk version mapping

| @arcanumdex/components | @_arcanumdex/sdk |
| ----------------------- | ---------------- |
| 4.0.4                   | 2.1.11           |
| <4.1.0                  | 3.0.1            |
| 4.1.0                   | 3.1.2            |
...
import './index.css';
import App from './App';
import { PangolinProvider } from '@arcanumdex/components';
...
3. do `yalc link "@arcanumdex/components"` in the project where you want to use components
